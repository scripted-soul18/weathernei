...
export const WeatherCard: React.FC<WeatherCardProps> = ({ weather, isLoading = false }) => {
  return (
    <div className="w-full glass-panel bg-white/80 dark:bg-slate-900/80 rounded-2xl p-5 border border-slate-200/90 dark:border-slate-800 shadow-xl flex flex-col justify-between relative overflow-hidden transition-colors duration-300">
      {/* Glow highlight */}
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800/80 mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-slate-900 dark:text-slate-100 text-sm tracking-wide">Current Weather</h3>
        </div>
        <span className="text-xs px-2.5 py-0.5 rounded-md bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 font-mono font-medium">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        {/* Temperature */}
        <div className="bg-slate-50/90 dark:bg-slate-900/60 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] font-medium text-slate-500 dark:text-slate-400">Surface Temp</div>
          </div>
        </div>

        {/* 24h Rainfall */}
        <div className="bg-slate-50/90 dark:bg-slate-900/60 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center gap-3">
          <div className="p-2.5 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-cyan-600 dark:text-cyan-400">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        {/* Rainfall Windows */}
        <div className="bg-slate-50/70 dark:bg-slate-900/40 p-2.5 rounded-xl border border-slate-200/90 dark:border-slate-800/80 flex flex-col">
